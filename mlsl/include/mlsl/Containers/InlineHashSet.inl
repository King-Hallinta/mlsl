...
namespace mlsl
{
	...
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet()
		: m_Allocator(new DefaultAllocator()), m_OwnsAllocator(true)
	{
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet(Allocator *allocator)
		: m_Allocator(allocator == nullptr ? new DefaultAllocator() : allocator), m_OwnsAllocator(allocator == nullptr)
	{
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet(HashT hash, EqualT equal)
		: Base(std::move(hash), std::move(equal)), m_Allocator(new DefaultAllocator()), m_OwnsAllocator(true)
	{
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet(Allocator *allocator, HashT hash, EqualT equal)
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet(const InlineHashSet &other)
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT>::InlineHashSet(InlineHashSet &&other) noexcept
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT> &InlineHashSet<KeyT, N, HashT, EqualT>::operator=(const InlineHashSet &other)
	{
		if (this != &other)
		{
			this->Clear();
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	InlineHashSet<KeyT, N, HashT, EqualT> &InlineHashSet<KeyT, N, HashT, EqualT>::operator=(InlineHashSet &&other) noexcept
	{
		if (this != &other)
		{
			this->Clear();
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	typename InlineHashSet<KeyT, N, HashT, EqualT>::SizeType InlineHashSet<KeyT, N, HashT, EqualT>::InlineCapacity() const
	{
		return N;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	typename InlineHashSet<KeyT, N, HashT, EqualT>::Slot *InlineHashSet<KeyT, N, HashT, EqualT>::GetSlots()
	{
		return m_Slots;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	const typename InlineHashSet<KeyT, N, HashT, EqualT>::Slot *InlineHashSet<KeyT, N, HashT, EqualT>::GetSlots() const
	{
		return m_Slots;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	typename InlineHashSet<KeyT, N, HashT, EqualT>::SizeType InlineHashSet<KeyT, N, HashT, EqualT>::GetSlotCount() const
	{
		return m_SlotCount;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	typename InlineHashSet<KeyT, N, HashT, EqualT>::SizeType InlineHashSet<KeyT, N, HashT, EqualT>::GetCapacity() const
	{
		return m_Capacity;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	std::expected<void, Error> InlineHashSet<KeyT, N, HashT, EqualT>::EnsureCapacity(SizeType capacity)
	{
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	bool InlineHashSet<KeyT, N, HashT, EqualT>::IsInline() const
	{
		return m_Slots == m_InlineSlots;
	}

	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	std::expected<typename InlineHashSet<KeyT, N, HashT, EqualT>::Slot *, Error> InlineHashSet<KeyT, N, HashT, EqualT>::AllocateSlots(SizeType slotCount)
	{
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	void InlineHashSet<KeyT, N, HashT, EqualT>::DestroySlotArray(Slot *slots, SizeType slotCount)
	{
		for (SizeType i = 0; i < slotCount; ++i)
		{
			slots[i].~Slot();
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	void InlineHashSet<KeyT, N, HashT, EqualT>::ReleaseHeapSlots()
	{
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	std::expected<void, Error> InlineHashSet<KeyT, N, HashT, EqualT>::Rebuild(SizeType slotCount)
	{
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	void InlineHashSet<KeyT, N, HashT, EqualT>::CopyFrom(const InlineHashSet &other)
	{
	...
	template <typename KeyT, std::size_t N, typename HashT, typename EqualT>
	void InlineHashSet<KeyT, N, HashT, EqualT>::MoveFrom(InlineHashSet &other)
	{
